            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full rounded-lg border border-slate-300 bg-white px-4 py-3 text-ink placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#0070f3] focus:border-transparent"
                />
              </div>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <select
                    ...
                    className="w-24 rounded-lg border border-slate-300 bg-white px-3 py-3 text-ink focus:outline-none focus:ring-2 focus:ring-[#0070f3] focus:border-transparent"
                  >
                    {CURRENCIES.map((curr) => (
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-slate-300 bg-white px-4 py-3 text-ink focus:outline-none focus:ring-2 focus:ring-[#0070f3] focus:border-transparent"
                />
              </div>
