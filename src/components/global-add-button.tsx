  ...
  return (
    <>
      ...
      <button
        ...
        className="hidden md:flex fixed bottom-8 right-8 w-14 h-14 rounded-full bg-[#0070f3] text-white items-center justify-center shadow-lg hover:bg-[#0060df] transition-all hover:scale-105 active:scale-95 z-40"
        title="Add expense (n)"
      >
