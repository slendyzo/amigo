  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="flex items-center gap-2 px-3 py-1.5 rounded-lg hover:bg-paper-soft transition-colors text-left"
      >
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="text-sm font-medium text-ink truncate max-w-[120px]">
              {displayName}
            </div>
          </div>
        </div>
      ...
      {/* Dropdown */}
      {isOpen && (
        <div className="absolute left-0 mt-1 w-64 bg-paper-deep rounded-lg shadow-lg border border-rule py-1 z-50">
          {isLoading ? (
            <div className="px-4 py-3 text-sm text-ink-mute text-center">
              {t("loading") || "Loading..."}
            </div>
          ) : (
            <>
              ...
              <Link
                ...
                className="w-full px-4 py-2 flex items-center gap-2 text-sm text-ink-soft hover:bg-paper-soft transition-colors"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <Link
                ...
                onClick={() => setIsOpen(false)}
                className="w-full px-4 py-2 flex items-center gap-2 text-sm text-forest hover:bg-paper-soft transition-colors"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
