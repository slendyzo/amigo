      ...
      <div className="w-full max-w-md text-center">
        ...
        {error && (
          <div className="mb-6 p-3 rounded-lg bg-slate-100 text-sm">
            ...
            <code className="text-slate-700">{error}</code>
          </div>
        )}
        ...
        <div className="space-y-3">
          ...
          <a
            href="/"
            className="block w-full rounded-lg border border-slate-300 px-4 py-3 text-slate-700 font-medium hover:bg-slate-50 transition-colors"
          >
            Back to Home
          </a>
        </div>
