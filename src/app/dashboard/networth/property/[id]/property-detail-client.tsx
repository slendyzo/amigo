...
export default function PropertyDetailClient({
  ...
  return (
    <div className="space-y-6">
      ...
      <AssetHero
        sold={sold}
        imageBgClass="bg-gradient-to-br from-violet-500/10 to-violet-500/5"
        imageNode={(() => {
          const map =
          ...
          if (asset.imageUrl) {
            return (
              ...
              <img
                ...
                alt={asset.name}
                loading="lazy"
                className={cn("h-full w-full object-cover", sold && "opacity-60 grayscale")}
              />
            );
          }
          if (map) {
        ...
        stats={[
          ...
          },
          {
            ...
            value: formatCurrency(
              sold && asset.salePriceEur != null ? asset.salePriceEur : current,
              "EUR",
            ),
            hint: sold ? undefined : (
              <ValueSourceHint
