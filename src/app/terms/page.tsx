      ...
      <div className="max-w-3xl mx-auto">
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-slate-900 mb-4">3. No Financial Advice</h2>
              <p className="text-slate-600 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-slate-900 mb-4">4. Use at Your Own Risk</h2>
              <p className="text-slate-600 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-slate-900 mb-4">6. Open Source</h2>
              <p className="text-slate-600 mb-4">
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-600 mb-4 uppercase font-medium">
